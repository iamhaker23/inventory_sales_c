...
${OBJECTDIR}/Record.o: Record.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Record.o Record.c
...
${OBJECTDIR}/duration.o: duration.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/duration.o duration.c
...
${TESTDIR}/tests/InventorySimpleTest.o: tests/InventorySimpleTest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/InventorySimpleTest.o tests/InventorySimpleTest.c
...
${TESTDIR}/tests/StockItemSimpleTest.o: tests/StockItemSimpleTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StockItemSimpleTest.o tests/StockItemSimpleTest.c
...
${OBJECTDIR}/Date_nomain.o: ${OBJECTDIR}/Date.o Date.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Date_nomain.o Date.c;\
	else  \
...
${OBJECTDIR}/Record_nomain.o: ${OBJECTDIR}/Record.o Record.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Record_nomain.o Record.c;\
	else  \
...
${OBJECTDIR}/duration_nomain.o: ${OBJECTDIR}/duration.o duration.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/duration_nomain.o duration.c;\
	else  \
